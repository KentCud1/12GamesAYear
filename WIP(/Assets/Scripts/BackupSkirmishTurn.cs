...
public class BackupSkirmishTurn {
    CharacterGroup attacker, defender;
    public BackupSkirmishTurn(CharacterGroup _attacker, CharacterGroup _defender) {
        attacker = _attacker;
        defender = _defender;
    ...
    private SkirmishTurn TakeTurn(CharacterGroup attacker, CharacterGroup defender) {
        ...
        return new SkirmishTurn(defender, attacker);
    }
}
